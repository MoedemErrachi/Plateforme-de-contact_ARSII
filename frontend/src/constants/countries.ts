/**
 * Liste complète des pays souverains (ONU + observateurs) avec libellés
 * en français. Utilisée par les formulaires de contact : le choix du pays
 * conditionne l'activation du champ « Ville » (saisie libre).
 */
