...
export const Header: React.FC<HeaderProps> = ({
  ...
  // RBAC strict : l'administrateur ne voit que l'espace d'administration.
  const navLinks: { to: string; label: string }[] = user?.role === 'admin'
            ...
            <div className="relative" ref={profileRef}>
              ...
              {profileDropdownOpen && (
                <div className="absolute right-0 top-full mt-2 w-56 bg-white rounded-xl shadow-2xl border border-slate-200 py-2 text-slate-800 z-[100] animate-in fade-in slide-in-from-top-1 duration-150">
                  ...
                  {user?.role === 'admin' ? (
                    /* Console d'administration : strictement deux entrées. */
                    <div className="py-1">
                      <Link
                        to="/profile"
